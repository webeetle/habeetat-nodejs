...
non c'è da meravigliarsi se sul terminale verra stampato il seguente messaggio:
...
`then` restituisce un valore allora quel valore sarà a una promise. Quindi possiamo creare una catena di prototipi dove propagiamo la 
